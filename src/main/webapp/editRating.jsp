...
<%@ include file="head.jsp"%>
    <main class="container mx-auto mt-8 mb-10 p-6 bg-white shadow-md rounded-lg">
        ...
        <form class="space-y-4" action="${pageContext.request.contextPath}/EditRatingSuccessful" method="post">
            <div>
                <label for="name" class="block font-medium">Your Name</label>
                <input type="text" id="name" name="fullname" value="${rating.fullname}" class="w-full p-2 border border-gray-300 rounded" placeholder="Enter your name" readonly>
            </div>

            <div>
                <label for="tour" class="block font-medium">Tour No</label>
                <input type="text" id="tour" name="activiNo" value="${rating.activiNo}" class="w-full p-2 border border-gray-300 rounded" placeholder="Enter tour name" readonly>
            </div>
            ...
            <input type="text" id="id" value="${rating.id}" name="id" hidden>

            <div>
                <label for="feedback" class="block font-medium">Your Feedback</label>
                <textarea id="feedback" rows="4" name="describeRating" class="w-full p-2 border border-gray-300 rounded" placeholder="Share your experience...">${rating.describeRating}</textarea>
            </div>
...
<%@ include file="footer.jsp"%>
    <script>
        ...
        let ratingValue = parseInt("${rating.rating}", 10) || 0;
